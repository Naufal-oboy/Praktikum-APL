                    ...
                    if (loginBerhasil) {
                        ...
                        while (!isLogout) {
                            ...
                            if (peranPengguna == "admin") {
                                ...
                                cin >> pilihanMenu;
                                switch (pilihanMenu) {
                                    case 1: tambahLapangan(); break;
                                    case 2: lihatLapangan(); break;
                                    case 3: ubahLapangan(); break;
                                    case 4: hapusLapangan(); break;
                                    case 5: isLogout = true; cout << "Logout berhasil." << endl; break;
                                ...
                                switch (pilihanMenu) {
                                    ...
                                    case 2: isLogout = true; cout << "Logout berhasil." << endl; break;
                                    default: cout << "Pilihan tidak valid!" << endl;
                                }
                            }
                        }
